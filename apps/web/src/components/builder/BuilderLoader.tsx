        ...
        switch (phase) {
            ...
            case PHASE_TYPES.GENERATING:
                return {
                    ...
                    description: 'Writing app screens, routes, and supporting code',
                };
            ...
            case PHASE_TYPES.COMPLETE:
                return {
                    title: 'Complete',
                    description: 'Your app workspace is ready',
                };
            case STAGE.FINALIZING:
                return {
                    title: 'Finalizing',
                    description: 'Getting your project ready for review and deployment',
                };
            default:
                return {
                    title: 'Processing',
