...
const featureData = [
    {
        topTitle: 'AI PRODUCT',
        centerTitle: 'Web Apps',
        bottomTitle: 'Single Prompt',
        description: 'Generate SaaS screens, dashboards, portals, and workflows from natural language',
        icon: FaCode,
        color: '#3E68E8',
    ...
    {
        topTitle: 'FAST',
        centerTitle: 'Prototype',
        bottomTitle: 'Live Preview',
        description: 'Go from idea to a reviewable interface and working project files',
        icon: FaBolt,
        color: '#F5B642',
    ...
    },
    {
        ...
        description: 'Chat, file tree, editor, terminal, and project plan in one browser workspace',
        icon: LighthouseMark,
        color: '#8EAAFF',
        gradient: 'from-[#3E68E8]/30 to-[#3DDC97]/20',
    },
    {
        topTitle: 'WEB2 READY',
        centerTitle: 'Frontend + API',
        bottomTitle: 'App Ready',
        description: 'Generated projects use familiar app structure, routes, components, and API glue',
        icon: LighthouseMark,
        color: '#3E68E8',
        gradient: 'from-blue-500/20 to-cyan-500/20',
    },
    {
        ...
        centerTitle: 'Review',
        bottomTitle: 'Checks',
        description: 'The agent explains its plan, updates files, and prepares the project for launch',
        icon: FaShieldAlt,
        color: '#3DDC97',
            ...
            <div className="sticky top-0 w-screen h-screen flex flex-col items-center justify-start pt-26 md:px-10 gap-x-16 overflow-hidden rounded-[4px]">
                ...
                >
                    <div className="mt-4 w-full flex justify-center text-[7px] sm:text-sm md:text-2xl tracking-widest text-darkest font-semibold text-center px-4">
                        Transform your product ideas into&nbsp;
                        <Highlighter action="underline" color="#5483B3">
                            production-ready
                        </Highlighter>
                        &nbsp;web apps with an editable workspace.
                    </div>
                </motion.div>
